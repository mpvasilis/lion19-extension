...
def construct_jsudoku_binary(grid_size=9, regions=None):
    """
    Construct a Jigsaw Sudoku (JSudoku) instance with binary constraints.
    ...
    # Constraints on irregular regions (decomposed to binary)
...
def construct_jsudoku_binary_4x4():
    """
    Construct a 4x4 JSudoku with binary constraints for testing.
    """
    regions = [
        # Region 0 (irregular)
        [(0,0), (0,1), (1,0), (1,1)],
...
def construct_jsudoku_binary_6x6():
    """
    Construct a 6x6 JSudoku with binary constraints.
    """
    regions = [
        # Region 0
