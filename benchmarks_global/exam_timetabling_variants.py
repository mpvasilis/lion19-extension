...
def construct_examtt_variant1(nsemesters=6, courses_per_semester=5, slots_per_day=6, days_for_exams=10):
    ...
    # Mock 4: Middle semester courses should form AllDifferent on specific slots
    if nsemesters >= 3 and courses_per_semester >= 3:
        middle_sem = nsemesters // 2
        middle_courses = variables[middle_sem, :3]
        mock_c4 = cp.AllDifferent(middle_courses)  # Already true, but redundant
